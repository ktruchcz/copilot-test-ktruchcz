...
handoffs: 
  - label: "Skills Creation"
    agent: "transformation.cookbooks.mapper"
    prompt: "Map the migration process to skills and create them in the repository."
    send: true
...
1. **Skills Creation**
   - Handoff to `transformation.cookbooks.mapper` with prompt: "Map the migration process to skills and create them in the repository."
   - Wait for Pull Request to be merged before proceeding.
