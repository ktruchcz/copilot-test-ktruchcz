 ...
 *   <li>Sealed interfaces &amp; pattern matching (Java 25 runtime; feature GA since Java 21)</li>
 * </ul>
 */
// generated by AI in Github cloud
public class HelloWorld {
    ...
    /** Simple sealed hierarchy used to show pattern matching in a switch on Java 25. */
    sealed interface TimeOfDay permits TimeOfDay.Morning, TimeOfDay.Afternoon, TimeOfDay.Evening {
        ...
        static TimeOfDay of(int hour) {
            // Box to Integer so the switch can use guarded pattern matching on Java 25
    ...
    public static void main(String[] args) {
        ...
        // Switch expression with pattern matching on Java 25
