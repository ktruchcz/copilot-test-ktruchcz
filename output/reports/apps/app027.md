...
| Integration | 8/10 | High integration surface with 20 external interfaces and 5 APIs. |
...
| Data | 8/10 | 1 database engine(s), 5000 GB storage. |
...
- **Cost:** €15295 (one-time)
- **Savings:** €9600/year
- **Reasoning:** Websphere 8.5 is assessed as EOL and should be modernized or replaced.
