...
| Language | Fortran | 2018 | 🟢 CURRENT_VERSION |
...
| Integration | 3/10 | The application has limited integration signals (1 interfaces). |
...
| Data | 7/10 | Database footprint (1500 GB) and/or legacy database technology increase data migration complexity. |
...
| Upgrade Legacy Databases | LACK_OF_DATA | DB2 version is not provided, so lifecycle status cannot be assessed reliably. |
