...
| Language | FORTRAN 2018 | FORTRAN 2018 | 🟡 OUTDATED |
...
**Reasoning:** Tech age score 6/10 (0 EOL, 2 outdated components). Integration score 3/10 (1 external interfaces). Infrastructure score 3/10 (1 servers, 2 environments). Business criticality score 5/10 (criticality: Critical). Architecture score 8/10 (architecture: 1-Tier, containerized: No, CI/CD: No). Data score 6/10 (1500GB storage).
...
- **Cost:** N/A (one-time)
- **Savings:** N/A
- **Reasoning:** Database 'DB2' is a proprietary/commercial database. Switching to open-source (e.g., PostgreSQL) would reduce licensing costs.
...
- **Cost:** N/A (one-time)
- **Savings:** N/A
- **Reasoning:** Programming language 'FORTRAN 2018' is OUTDATED. Component updates are needed.
...
| Upgrade Legacy Databases | LACK_OF_DATA | Cannot determine lifecycle status of database 'DB2'.... |

## Financial Summary

| Metric | Value |
|--------|-------|
| Total One-Time Cost | €257,756 |
