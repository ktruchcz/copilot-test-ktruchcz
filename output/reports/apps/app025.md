...
| Language | ASP.NET Core | 🟡 OUTDATED |
...
> Complexity score 6/10 (MEDIUM). 1 outdated component(s), 15 external interfaces.
...
- **Cost:** N/A (one-time)
- **Savings:** N/A
- **Reasoning:** Components need updating. Outdated: ASP.NET Core.
...
| Upgrade Legacy Databases | FULFILLED | Database (PostgreSQL 15) is on a current, supported version. |
| Switch DB Engine to open-source database solution | FULFILLED | Database (PostgreSQL 15) is already open-source or compatible. |

## Financial Summary

| Metric | Value |
|--------|-------|
| Total One-Time Investment | €289,133 |
