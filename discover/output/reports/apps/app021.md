...
> Complexity MEDIUM (6/10). Technology age: 8/10 (1 EOL, 0 outdated components). Integration: 4/10 (4 external interfaces). Infrastructure: 4/10 (2 servers). Business criticality High: 7/10. Architecture 2-tier: 8/10. Data complexity: 7/10.
...
- **Reason:** Database Oracle 11g has status EOL. Upgrade recommended.
- **Confidence:** 8/10
...
- **Reason:** Proprietary database Oracle 11g detected. Switch to open-source (e.g., PostgreSQL) is applicable.
- **Confidence:** 8/10
